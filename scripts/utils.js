...
export class MrResettiUtils {
  ...
  static createTooltipChatMessage(message) {
    if (MrResettiModuleSettings.getIsTooltipsEnabled()) {
      const entireMessage = "MrResetti Module Tip:<br><br>" + message + "<br><br> (If you don't like these messages, they can be disabled in Game Settings -> Game Settings -> MrResetti module -> tool tips Off)"
      ChatMessage.create({
